...
def main():
    ...
    if away_matches:
        for i, match in enumerate(away_matches, 1):
            print(scraper._format_match(match, i))
        ...
        print("Nenhum jogo agendado encontrado 🚫⚽")
...
{self.detalhes_jogo.get('Transmissão TV', '') if self.detalhes_jogo.get('Transmissão TV') else ''}
------------------------------------
